...
namespace Deep
{
    public class DeepViewManager : MonoBehaviour
    {
        ...
        public Transform inactiveViewParent { get; private set; }
        //holds views that are trying to return, but are waiting on something ex: trails
        public Transform returningViewParent { get; private set; }
        ...
        /// <summary>
        /// Returns an INACTIVE view. It will still be parented to viewManager.
        /// </summary>
